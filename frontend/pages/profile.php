...
// Importar el archivo de configuración de la API y el cliente HTTP (puedes necesitar ajustar la ruta)
require_once('../api/config.php');
require_once('../api/HttpClient.php');

// Obtener el token de acceso de la sesión (asegúrate de tener una forma segura de gestionar los tokens en tu aplicación)
            ...
            <form class="flex flex-col text-gray-BD text-sm leading-6">
                ...
                <div class="flex items-center justify-between sm:justify-start border-t border-gray-BD p-2 px-5 sm:px-12">
                    ...
                    <div class="h-20 w-20  overflow-hidden rounded-lg ">
                        <img class="w-full h-full object-cover" src="../pictures/<?php echo isset($userData['photo']) ? $userData['photo'] : 'usuario.jpg' ?>" alt="">
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between sm:justify-start border-t border-gray-BD p-6   px-5 sm:px-12">
                    ...
                    <h3 class="text-lg text-gray-33 whitespace-nowrap"><?php echo isset($userData['name']) ? $userData['name'] : '' ?></h3>
                </div>
                ...
                <div class="flex items-center justify-between sm:justify-start border-t border-gray-BD p-6 px-5 sm:px-12 cursor-pointer">
                    ...
                    <h3 class="max-w-md text-lg text-gray-33 text-ellipsis whitespace-nowrap transition-all  hover:duration-1000 transform h-7 duration-200  hover:overflow-y-scroll  hover:h-40 overflow-hidden hover:whitespace-normal "><?php echo isset($userData['bio']) ? $userData['bio'] : '' ?></h3>
                </div>

                <!-- Sección del teléfono -->
                <div class="flex items-center justify-between sm:justify-start border-t border-gray-BD p-6 px-5 sm:px-12">
                    <h3 class="w-52">PHONE</h3>
                    <h3 class="text-lg text-gray-33 whitespace-nowrap"><?php echo isset($userData['phone']) ? $userData['phone'] : '' ?></h3>
                </div>

                <!-- Sección del correo electrónico -->
                <div class="flex items-center justify-between sm:justify-start border-t border-gray-BD p-6 px-5 sm:px-12">
                    <h3 class="w-52">EMAIL</h3>
                    <h3 class="text-lg text-gray-33 whitespace-nowrap"><?php echo isset($userData['email']) ? $userData['email'] : '' ?></h3>
                </div>
